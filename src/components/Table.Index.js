  ...
  return (
    <div className='w-full relative px-3'>
      ...
      <div className="sec m-auto my-10 space-y-8 w-1/2 mob:w-full flex flex-col">
        ...
        /> */}
        <h1 className="text-center"><b>Level Sabke Niklenge! <br/>Lekin niklenge uske jo pathways complete karega!</b></h1>
      ...
      <table className='mx-auto table-fixed m-5  '>
        <thead className='shadow-md text-sm bg-blue-500 text-gray-200 sticky top-2 z-10'>
          <tr className='text-center '>
            ...
            <td className="mob:hidden rounded-se-lg p-2 max-w-[150px]">Gen AI Arcade Game Completion</td>
          </tr>
        </thead>
        <TableBody
